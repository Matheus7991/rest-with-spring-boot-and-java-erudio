...
class BookServicesTest {
	...
	void testFindById() {
		...
		assertEquals("Matheus1", result.getAuthor());
	...
	void testFindAll() {
		...
		assertEquals("Matheus1", bookOne.getAuthor());
		assertNotNull(bookOne.getLaunchDate());
		assertEquals(bookOne.getKey().doubleValue(), bookOne.getPrice());
		...
		assertEquals("Matheus4", bookFour.getAuthor());
		assertNotNull(bookFour.getLaunchDate());
		assertEquals(bookFour.getKey().doubleValue(), bookFour.getPrice());
		...
		assertEquals("Matheus7", bookSeven.getAuthor());
		assertNotNull(bookSeven.getLaunchDate());
		assertEquals(bookSeven.getKey().doubleValue(), bookSeven.getPrice());
