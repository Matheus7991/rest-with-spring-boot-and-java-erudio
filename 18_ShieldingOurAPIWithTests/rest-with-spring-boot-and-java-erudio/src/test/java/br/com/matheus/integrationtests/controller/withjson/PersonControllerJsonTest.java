...
public class PersonControllerJsonTest extends AbstractIntegrationTest{
	...
	public void authorization() throws JsonMappingException, JsonProcessingException {
		...
		specification = new RequestSpecBuilder()
				.addHeader(TestConfigs.HEADER_PARAM_AUTHORIZATION, "Beares " + accessToken)
	...
	public void testCreate() throws JsonMappingException, JsonProcessingException {
		...
		assertNotNull(persistedPerson.getFirsName());
		...
		assertEquals("Richard", persistedPerson.getFirsName());
	...
	public void testCreateWithWrongOrigin() throws JsonMappingException, JsonProcessingException {
		...
		var content = given().spec(specification)
				.contentType(TestConfigs.CONTENT_TYPE_JSON)
				.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_SEMATHEUS)
					.body(person)
				.when()
					.post()
				.then()
