...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        assertEquals("First Name Test0", output.getFirsName());
    ...
    public void parseEntityListToVOListTest() {
        ...
        assertEquals("First Name Test0", outputZero.getFirsName());
        ...
        assertEquals("First Name Test7", outputSeven.getFirsName());
        ...
        assertEquals("First Name Test12", outputTwelve.getFirsName());
